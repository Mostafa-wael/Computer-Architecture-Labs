...
radix signal sim:/partD/sel Binary
...
force -freeze sim:/partD/sel 2#00 0
#run simulation 
run 

#testCase2 -> E01F, 1
force -freeze sim:/partD/a 16#F00F 0
force -freeze sim:/partD/sel 2#01 0
#run simulation 
run 
...
force -freeze sim:/partD/sel 2#10 0
#run simulation 
run 
...
#testCase5 -> 0000, 0
force -freeze sim:/partD/a 16#F00F 0
force -freeze sim:/partD/sel 2#11 0
#run simulation 
run 
